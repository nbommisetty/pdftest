...
Ensure you have the "Extension Pack for Java" installed. Lombok support is usually bundled.

You might need to restart VS Code or run "Java: Clean Java Language Server Workspace" from the Command Palette (Ctrl+Shift+P or Cmd+Shift+P).

Eclipse:

Locate the lombok.jar file in your local Maven repository (e.g., ~/.m2/repository/org/projectlombok/lombok/{version}/lombok-{version}.jar).

Run java -jar lombok-{version}.jar from your terminal. This will open an installer GUI.

Select your Eclipse installation directory and click "Install/Update".
...
Add PostgreSQL Driver: Uncomment the PostgreSQL dependency in pom.xml and comment out the H2 dependency.

Update application.properties: Modify the database connection properties to point to your PostgreSQL instance:
...
Ensure PostgreSQL is running and your database (your_database_name) exists.
